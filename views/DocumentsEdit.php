...
<?php if ($Page->document_id->Visible) { // document_id ?>
    <div id="r_document_id"<?= $Page->document_id->rowAttributes() ?>>
        <label id="elh_documents_document_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->document_id->caption() ?><?= $Page->document_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="documents" data-field="x_document_id" data-hidden="1" name="x_document_id" id="x_document_id" value="<?= HtmlEncode($Page->document_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fdocumentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdocumentsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdocumentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdocumentsedit", "x_updated_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdocumentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdocumentsedit", "x_submitted_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdocumentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdocumentsedit", "x_date_of_entry", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fdocumentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fdocumentsedit", "x_deletion_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
