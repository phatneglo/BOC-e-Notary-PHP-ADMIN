...
$sideMenu->addMenuItem(76, "mi_document_statuses", $Language->menuPhrase("76", "MenuText"), "DocumentStatusesList", -1, "", AllowListMenu('{eNotary}document_statuses'), false, false, "", "", false, true);
$sideMenu->addMenuItem(77, "mi_document_status_view", $Language->menuPhrase("77", "MenuText"), "DocumentStatusViewList", -1, "", AllowListMenu('{eNotary}document_status_view'), false, false, "", "", false, true);
