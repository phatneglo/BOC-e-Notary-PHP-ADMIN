...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fnotarization_requestsadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fnotarization_requestsadd" id="fnotarization_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script>
loadjs.ready(["fnotarization_requestsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fnotarization_requestsadd", "x_requested_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fnotarization_requestsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fnotarization_requestsadd", "x_assigned_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fnotarization_requestsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fnotarization_requestsadd", "x_notarized_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fnotarization_requestsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fnotarization_requestsadd", "x_rejected_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fnotarization_requestsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fnotarization_requestsadd", "x_modified_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fnotarization_requestsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fnotarization_requestsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
