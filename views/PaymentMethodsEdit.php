...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        ...
        // Add fields
        .setFields([
            ["method_id", [fields.method_id.visible && fields.method_id.required ? ew.Validators.required(fields.method_id.caption) : null], fields.method_id.isInvalid],
...
<?php if ($Page->method_id->Visible) { // method_id ?>
    <div id="r_method_id"<?= $Page->method_id->rowAttributes() ?>>
        <label id="elh_payment_methods_method_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->method_id->caption() ?><?= $Page->method_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->method_id->cellAttributes() ?>>
<span id="el_payment_methods_method_id">
<span<?= $Page->method_id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->method_id->getDisplayValue($Page->method_id->EditValue))) ?>"></span>
<input type="hidden" data-table="payment_methods" data-field="x_method_id" data-hidden="1" name="x_method_id" id="x_method_id" value="<?= HtmlEncode($Page->method_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fpayment_methodsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpayment_methodsedit", "x_created_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fpayment_methodsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpayment_methodsedit", "x_updated_at", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
