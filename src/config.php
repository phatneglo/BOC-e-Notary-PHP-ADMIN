...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/eNotary.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\eNotary\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\eNotary\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-enotary", // Export folder
    ...
    // File upload
    "UPLOAD_TEMP_PATH" => "D:/Projects/AITBS/document-tracking-php/tmp_uploads", // Upload temp path (absolute local physical path)
    "UPLOAD_TEMP_HREF_PATH" => "//dgtms.local/temp_uploads", // Upload temp href path (absolute URL path for download)
