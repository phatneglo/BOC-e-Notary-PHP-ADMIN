 ...
 * Page class
 */
class FeeSchedulesDelete extends FeeSchedules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FeeSchedulesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "FeeSchedulesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FeeSchedulesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("FeeSchedulesList"); // Return to list
                return;
            }
        }
