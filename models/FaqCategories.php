...
/**
 * Table class for faq_categories
 */
class FaqCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "faq_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'faq_categories', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "faq_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FaqCategoriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "FaqCategoriesView" => $Language->phrase("View"),
            "FaqCategoriesEdit" => $Language->phrase("Edit"),
            "FaqCategoriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FaqCategoriesView",
            Config("API_ADD_ACTION") => "FaqCategoriesAdd",
            Config("API_EDIT_ACTION") => "FaqCategoriesEdit",
            Config("API_DELETE_ACTION") => "FaqCategoriesDelete",
            Config("API_LIST_ACTION") => "FaqCategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FaqCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("FaqCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "FaqCategoriesAdd?" . $parm;
        } else {
            $url = "FaqCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FaqCategoriesDelete", $parm);
        }
    }
