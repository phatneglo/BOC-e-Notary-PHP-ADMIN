...
/**
 * Table class for template_categories
 */
class TemplateCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "template_categories";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'template_categories', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "template_categories";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TemplateCategoriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TemplateCategoriesView" => $Language->phrase("View"),
            "TemplateCategoriesEdit" => $Language->phrase("Edit"),
            "TemplateCategoriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TemplateCategoriesView",
            Config("API_ADD_ACTION") => "TemplateCategoriesAdd",
            Config("API_EDIT_ACTION") => "TemplateCategoriesEdit",
            Config("API_DELETE_ACTION") => "TemplateCategoriesDelete",
            Config("API_LIST_ACTION") => "TemplateCategoriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TemplateCategoriesView", $parm);
        } else {
            $url = $this->keyUrl("TemplateCategoriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TemplateCategoriesAdd?" . $parm;
        } else {
            $url = "TemplateCategoriesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TemplateCategoriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TemplateCategoriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TemplateCategoriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TemplateCategoriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TemplateCategoriesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TemplateCategoriesList";
