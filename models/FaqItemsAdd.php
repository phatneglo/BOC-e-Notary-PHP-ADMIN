 ...
 * Page class
 */
class FaqItemsAdd extends FaqItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaqItemsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "FaqItemsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FaqItemsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->view_count->DefaultValue = $this->view_count->getDefault(); // PHP
        $this->view_count->OldValue = $this->view_count->DefaultValue;
    }
    ...
    protected function getAddRow()
    {
        ...
        // question
        $this->question->setDbValueDef($rsnew, $this->question->CurrentValue, false);

        // answer
        $this->answer->setDbValueDef($rsnew, $this->answer->CurrentValue, false);
        ...
        // view_count
        $this->view_count->setDbValueDef($rsnew, $this->view_count->CurrentValue, strval($this->view_count->CurrentValue) == "");
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['question'])) { // question
            $this->question->setFormValue($row['question']);
        }
        if (isset($row['answer'])) { // answer
            $this->answer->setFormValue($row['answer']);
        }
        ...
        if (isset($row['view_count'])) { // view_count
            $this->view_count->setFormValue($row['view_count']);
        }
        if (isset($row['tags'])) { // tags
            $this->tags->setFormValue($row['tags']);
        }
    }
