...
/**
 * Table class for document_activity_logs
 */
class DocumentActivityLogs extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_activity_logs";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->document_id->Required = true; // Required field
        ...
        $this->_action->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_activity_logs";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentActivityLogsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DocumentActivityLogsView" => $Language->phrase("View"),
            "DocumentActivityLogsEdit" => $Language->phrase("Edit"),
            "DocumentActivityLogsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "DocumentActivityLogsList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DocumentActivityLogsView",
            Config("API_ADD_ACTION") => "DocumentActivityLogsAdd",
            Config("API_EDIT_ACTION") => "DocumentActivityLogsEdit",
            Config("API_DELETE_ACTION") => "DocumentActivityLogsDelete",
            Config("API_LIST_ACTION") => "DocumentActivityLogsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentActivityLogsView", $parm);
        } else {
            $url = $this->keyUrl("DocumentActivityLogsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentActivityLogsAdd?" . $parm;
        } else {
            $url = "DocumentActivityLogsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentActivityLogsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentActivityLogsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentActivityLogsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentActivityLogsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentActivityLogsDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "DocumentActivityLogsList";
