 ...
 * Page class
 */
class NotaryQrSettingsDelete extends NotaryQrSettings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotaryQrSettingsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NotaryQrSettingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NotaryQrSettingsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NotaryQrSettingsList"); // Return to list
                return;
            }
        }
