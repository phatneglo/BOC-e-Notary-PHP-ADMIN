 ...
 * Page class
 */
class FaqItemsView extends FaqItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaqItemsView";
    ...
    // CSS class/style
    public $CurrentPageName = "FaqItemsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("faq_id") ?? Route("faq_id")) !== null) {
            ...
            $returnUrl = "FaqItemsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FaqItemsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
