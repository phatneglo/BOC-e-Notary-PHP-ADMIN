 ...
 * Page class
 */
class TemplateFieldsDelete extends TemplateFields
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TemplateFieldsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TemplateFieldsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TemplateFieldsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TemplateFieldsList"); // Return to list
                return;
            }
        }
