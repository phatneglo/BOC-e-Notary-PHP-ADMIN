...
/**
 * Table class for faq_items
 */
class FaqItems extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // faq_id
        $this->faq_id = new DbField(
            $this, // Table
            'x_faq_id', // Variable name
            'faq_id', // Name
            '"faq_id"', // Expression
            'CAST("faq_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"faq_id"', // Virtual expression
            false, // Is virtual
        ...
        $this->faq_id->InputTextType = "text";
        $this->faq_id->Raw = true;
        $this->faq_id->IsAutoIncrement = true; // Autoincrement field
        $this->faq_id->IsPrimaryKey = true; // Primary key field
        $this->faq_id->Nullable = false; // NOT NULL field
        $this->faq_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->faq_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->question = new DbField(
            $this, // Table
            'x_question', // Variable name
            'question', // Name
            '"question"', // Expression
            '"question"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"question"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->question->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['question'] = &$this->question;

        // answer
        $this->answer = new DbField(
            $this, // Table
            'x_answer', // Variable name
            'answer', // Name
            '"answer"', // Expression
            '"answer"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"answer"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->answer->InputTextType = "text";
        $this->answer->Nullable = false; // NOT NULL field
        $this->answer->Required = true; // Required field
        $this->answer->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'faq_items', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // view_count
        $this->view_count = new DbField(
            $this, // Table
            'x_view_count', // Variable name
            'view_count', // Name
            '"view_count"', // Expression
            'CAST("view_count" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"view_count"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->view_count->addMethod("getDefault", fn() => 0);
        $this->view_count->InputTextType = "text";
        $this->view_count->Raw = true;
        $this->view_count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->view_count->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['view_count'] = &$this->view_count;

        // tags
        $this->tags = new DbField(
            $this, // Table
            'x_tags', // Variable name
            'tags', // Name
            '"tags"', // Expression
            '"tags"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"tags"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tags->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "faq_items";
    }
    ...
    public function insert(&$rs)
    {
        ...
        try {
            ...
            $result = $conn->executeQuery(
                $queryBuilder->getSQL() . " RETURNING faq_id",
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['faq_id']) && !EmptyValue($this->faq_id->CurrentValue)) {
                $rs['faq_id'] = $this->faq_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('faq_id', $rs)) {
                AddFilter($where, QuotedName('faq_id', $this->Dbid) . '=' . QuotedValue($rs['faq_id'], $this->faq_id->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->view_count->DbValue = $row['view_count'];
    ...
    {
        $keys = [];
        $val = $current ? $this->faq_id->CurrentValue : $this->faq_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->faq_id->CurrentValue = $keys[0];
            } else {
                $this->faq_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('faq_id', $row) ? $row['faq_id'] : null;
        } else {
            $val = !EmptyValue($this->faq_id->OldValue) && !$current ? $this->faq_id->OldValue : $this->faq_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@faq_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FaqItemsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "FaqItemsView" => $Language->phrase("View"),
            "FaqItemsEdit" => $Language->phrase("Edit"),
            "FaqItemsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FaqItemsView",
            Config("API_ADD_ACTION") => "FaqItemsAdd",
            Config("API_EDIT_ACTION") => "FaqItemsEdit",
            Config("API_DELETE_ACTION") => "FaqItemsDelete",
            Config("API_LIST_ACTION") => "FaqItemsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FaqItemsView", $parm);
        } else {
            $url = $this->keyUrl("FaqItemsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqItemsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqItemsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqItemsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FaqItemsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FaqItemsDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"faq_id\":" . VarToJson($this->faq_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->faq_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->faq_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("faq_id") ?? Route("faq_id")) !== null) {
                $arKeys[] = $keyValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->view_count);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->view_count);
