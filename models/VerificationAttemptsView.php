 ...
 * Page class
 */
class VerificationAttemptsView extends VerificationAttempts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VerificationAttemptsView";
    ...
    // CSS class/style
    public $CurrentPageName = "VerificationAttemptsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("attempt_id") ?? Route("attempt_id")) !== null) {
            $this->RecKey["attempt_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("attempt_id") ?? Route("attempt_id")) !== null) {
            ...
            $this->RecKey["attempt_id"] = $this->attempt_id->QueryStringValue;
        } elseif (Post("attempt_id") !== null) {
            $this->attempt_id->setFormValue(Post("attempt_id"));
            $this->RecKey["attempt_id"] = $this->attempt_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->attempt_id->setQueryStringValue($keyValue);
            $this->RecKey["attempt_id"] = $this->attempt_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "VerificationAttemptsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VerificationAttemptsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
