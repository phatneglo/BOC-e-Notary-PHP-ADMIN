 ...
 * Page class
 */
class DocumentTemplatesList extends DocumentTemplates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentTemplatesList";
    ...
    public $FormName = "fdocument_templateslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "DocumentTemplatesList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "DocumentTemplatesAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "DocumentTemplatesDelete";
        $this->MultiUpdateUrl = "DocumentTemplatesUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fdocument_templatesgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fdocument_templatessrch");
        }
        $filterList = Concat($filterList, $this->template_id->AdvancedSearch->toJson(), ","); // Field template_id
        $filterList = Concat($filterList, $this->template_name->AdvancedSearch->toJson(), ","); // Field template_name
        $filterList = Concat($filterList, $this->template_code->AdvancedSearch->toJson(), ","); // Field template_code
        $filterList = Concat($filterList, $this->category_id->AdvancedSearch->toJson(), ","); // Field category_id
        $filterList = Concat($filterList, $this->description->AdvancedSearch->toJson(), ","); // Field description
        $filterList = Concat($filterList, $this->html_content->AdvancedSearch->toJson(), ","); // Field html_content
        ...
        $filterList = Concat($filterList, $this->notary_required->AdvancedSearch->toJson(), ","); // Field notary_required
        $filterList = Concat($filterList, $this->fee_amount->AdvancedSearch->toJson(), ","); // Field fee_amount
        $filterList = Concat($filterList, $this->approval_workflow->AdvancedSearch->toJson(), ","); // Field approval_workflow
        $filterList = Concat($filterList, $this->template_type->AdvancedSearch->toJson(), ","); // Field template_type
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fdocument_templatessrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field template_name
        $this->template_name->AdvancedSearch->SearchValue = @$filter["x_template_name"];
        $this->template_name->AdvancedSearch->SearchOperator = @$filter["z_template_name"];
        $this->template_name->AdvancedSearch->SearchCondition = @$filter["v_template_name"];
        $this->template_name->AdvancedSearch->SearchValue2 = @$filter["y_template_name"];
        $this->template_name->AdvancedSearch->SearchOperator2 = @$filter["w_template_name"];
        $this->template_name->AdvancedSearch->save();

        // Field template_code
        $this->template_code->AdvancedSearch->SearchValue = @$filter["x_template_code"];
        $this->template_code->AdvancedSearch->SearchOperator = @$filter["z_template_code"];
        $this->template_code->AdvancedSearch->SearchCondition = @$filter["v_template_code"];
        $this->template_code->AdvancedSearch->SearchValue2 = @$filter["y_template_code"];
        $this->template_code->AdvancedSearch->SearchOperator2 = @$filter["w_template_code"];
        $this->template_code->AdvancedSearch->save();
        ...
        // Field html_content
        $this->html_content->AdvancedSearch->SearchValue = @$filter["x_html_content"];
        $this->html_content->AdvancedSearch->SearchOperator = @$filter["z_html_content"];
        $this->html_content->AdvancedSearch->SearchCondition = @$filter["v_html_content"];
        $this->html_content->AdvancedSearch->SearchValue2 = @$filter["y_html_content"];
        $this->html_content->AdvancedSearch->SearchOperator2 = @$filter["w_html_content"];
        $this->html_content->AdvancedSearch->save();
        ...
        // Field notary_required
        $this->notary_required->AdvancedSearch->SearchValue = @$filter["x_notary_required"];
        $this->notary_required->AdvancedSearch->SearchOperator = @$filter["z_notary_required"];
        $this->notary_required->AdvancedSearch->SearchCondition = @$filter["v_notary_required"];
        $this->notary_required->AdvancedSearch->SearchValue2 = @$filter["y_notary_required"];
        $this->notary_required->AdvancedSearch->SearchOperator2 = @$filter["w_notary_required"];
        $this->notary_required->AdvancedSearch->save();

        // Field fee_amount
        $this->fee_amount->AdvancedSearch->SearchValue = @$filter["x_fee_amount"];
        $this->fee_amount->AdvancedSearch->SearchOperator = @$filter["z_fee_amount"];
        $this->fee_amount->AdvancedSearch->SearchCondition = @$filter["v_fee_amount"];
        $this->fee_amount->AdvancedSearch->SearchValue2 = @$filter["y_fee_amount"];
        $this->fee_amount->AdvancedSearch->SearchOperator2 = @$filter["w_fee_amount"];
        $this->fee_amount->AdvancedSearch->save();

        // Field approval_workflow
        $this->approval_workflow->AdvancedSearch->SearchValue = @$filter["x_approval_workflow"];
        $this->approval_workflow->AdvancedSearch->SearchOperator = @$filter["z_approval_workflow"];
        $this->approval_workflow->AdvancedSearch->SearchCondition = @$filter["v_approval_workflow"];
        $this->approval_workflow->AdvancedSearch->SearchValue2 = @$filter["y_approval_workflow"];
        $this->approval_workflow->AdvancedSearch->SearchOperator2 = @$filter["w_approval_workflow"];
        $this->approval_workflow->AdvancedSearch->save();

        // Field template_type
        $this->template_type->AdvancedSearch->SearchValue = @$filter["x_template_type"];
        $this->template_type->AdvancedSearch->SearchOperator = @$filter["z_template_type"];
        $this->template_type->AdvancedSearch->SearchCondition = @$filter["v_template_type"];
        $this->template_type->AdvancedSearch->SearchValue2 = @$filter["y_template_type"];
        $this->template_type->AdvancedSearch->SearchOperator2 = @$filter["w_template_type"];
        $this->template_type->AdvancedSearch->save();

        // Field header_text
        $this->header_text->AdvancedSearch->SearchValue = @$filter["x_header_text"];
        $this->header_text->AdvancedSearch->SearchOperator = @$filter["z_header_text"];
        $this->header_text->AdvancedSearch->SearchCondition = @$filter["v_header_text"];
        $this->header_text->AdvancedSearch->SearchValue2 = @$filter["y_header_text"];
        $this->header_text->AdvancedSearch->SearchOperator2 = @$filter["w_header_text"];
        $this->header_text->AdvancedSearch->save();

        // Field footer_text
        $this->footer_text->AdvancedSearch->SearchValue = @$filter["x_footer_text"];
        $this->footer_text->AdvancedSearch->SearchOperator = @$filter["z_footer_text"];
        $this->footer_text->AdvancedSearch->SearchCondition = @$filter["v_footer_text"];
        $this->footer_text->AdvancedSearch->SearchValue2 = @$filter["y_footer_text"];
        $this->footer_text->AdvancedSearch->SearchOperator2 = @$filter["w_footer_text"];
        $this->footer_text->AdvancedSearch->save();

        // Field preview_image_path
        $this->preview_image_path->AdvancedSearch->SearchValue = @$filter["x_preview_image_path"];
        $this->preview_image_path->AdvancedSearch->SearchOperator = @$filter["z_preview_image_path"];
        $this->preview_image_path->AdvancedSearch->SearchCondition = @$filter["v_preview_image_path"];
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->template_name;
        $searchFlds[] = &$this->template_code;
        $searchFlds[] = &$this->description;
        $searchFlds[] = &$this->html_content;
        $searchFlds[] = &$this->approval_workflow;
        $searchFlds[] = &$this->template_type;
        $searchFlds[] = &$this->header_text;
        $searchFlds[] = &$this->footer_text;
        $searchFlds[] = &$this->preview_image_path;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->template_name); // template_name
            $this->updateSort($this->template_code); // template_code
            ...
            $this->updateSort($this->notary_required); // notary_required
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->template_name->setSort("");
                $this->template_code->setSort("");
                $this->category_id->setSort("");
                $this->description->setSort("");
                $this->html_content->setSort("");
                ...
                $this->notary_required->setSort("");
                $this->fee_amount->setSort("");
                $this->approval_workflow->setSort("");
                $this->template_type->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"document_templates\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"document_templates\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"document_templates\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdocument_templateslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdocument_templateslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->template_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"document_templates\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "template_name");
            $this->createColumnOption($option, "template_code");
            ...
            $this->createColumnOption($option, "notary_required");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdocument_templatessrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdocument_templatessrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdocument_templateslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_document_templates", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_document_templates",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdocument_templatessrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
