 ...
 * Page class
 */
class FeeSchedulesView extends FeeSchedules
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FeeSchedulesView";
    ...
    // CSS class/style
    public $CurrentPageName = "FeeSchedulesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("fee_id") ?? Route("fee_id")) !== null) {
            ...
            $returnUrl = "FeeSchedulesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FeeSchedulesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
