 ...
 * Page class
 */
class FaqItemsDelete extends FaqItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaqItemsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "FaqItemsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FaqItemsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("FaqItemsList"); // Return to list
                return;
            }
        }
