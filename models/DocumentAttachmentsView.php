 ...
 * Page class
 */
class DocumentAttachmentsView extends DocumentAttachments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentAttachmentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentAttachmentsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("attachment_id") ?? Route("attachment_id")) !== null) {
            $this->RecKey["attachment_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("attachment_id") ?? Route("attachment_id")) !== null) {
            ...
            $this->RecKey["attachment_id"] = $this->attachment_id->QueryStringValue;
        } elseif (Post("attachment_id") !== null) {
            $this->attachment_id->setFormValue(Post("attachment_id"));
            $this->RecKey["attachment_id"] = $this->attachment_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->attachment_id->setQueryStringValue($keyValue);
            $this->RecKey["attachment_id"] = $this->attachment_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DocumentAttachmentsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentAttachmentsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
