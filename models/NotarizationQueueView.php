 ...
 * Page class
 */
class NotarizationQueueView extends NotarizationQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotarizationQueueView";
    ...
    // CSS class/style
    public $CurrentPageName = "NotarizationQueueView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("queue_id") ?? Route("queue_id")) !== null) {
            ...
            $this->RecKey["queue_id"] = $this->queue_id->QueryStringValue;
        } elseif (Post("queue_id") !== null) {
            $this->queue_id->setFormValue(Post("queue_id"));
            $this->RecKey["queue_id"] = $this->queue_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->queue_id->setQueryStringValue($keyValue);
            $this->RecKey["queue_id"] = $this->queue_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "NotarizationQueueList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NotarizationQueueList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
