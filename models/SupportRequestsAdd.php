 ...
 * Page class
 */
class SupportRequestsAdd extends SupportRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportRequestsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportRequestsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SupportRequestsView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->reference_number->CurrentValue != "") { // Check field with unique index
            $filter = "(\"reference_number\" = '" . AdjustSql($this->reference_number->CurrentValue, $this->Dbid) . "')";
    ...
    protected function getAddRow()
    {
        ...
        // reference_number
        $this->reference_number->setDbValueDef($rsnew, $this->reference_number->CurrentValue, false);
        ...
        // resolved_at
        $this->resolved_at->setDbValueDef($rsnew, UnFormatDateTime($this->resolved_at->CurrentValue, $this->resolved_at->formatPattern()), false);

        // response
        $this->_response->setDbValueDef($rsnew, $this->_response->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['reference_number'])) { // reference_number
            $this->reference_number->setFormValue($row['reference_number']);
        }
        ...
        if (isset($row['resolved_at'])) { // resolved_at
            $this->resolved_at->setFormValue($row['resolved_at']);
        }
        if (isset($row['response'])) { // response
            $this->_response->setFormValue($row['response']);
        }
