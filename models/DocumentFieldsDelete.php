 ...
 * Page class
 */
class DocumentFieldsDelete extends DocumentFields
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentFieldsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentFieldsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentFieldsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DocumentFieldsList"); // Return to list
                return;
            }
        }
