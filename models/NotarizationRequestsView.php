 ...
 * Page class
 */
class NotarizationRequestsView extends NotarizationRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotarizationRequestsView";
    ...
    // CSS class/style
    public $CurrentPageName = "NotarizationRequestsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("request_id") ?? Route("request_id")) !== null) {
            ...
            $returnUrl = "NotarizationRequestsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NotarizationRequestsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
