 ...
 * Page class
 */
class DocumentActivityLogsView extends DocumentActivityLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentActivityLogsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentActivityLogsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("log_id") ?? Route("log_id")) !== null) {
            ...
            $returnUrl = "DocumentActivityLogsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentActivityLogsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
