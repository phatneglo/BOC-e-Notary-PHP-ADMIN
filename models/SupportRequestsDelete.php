 ...
 * Page class
 */
class SupportRequestsDelete extends SupportRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportRequestsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SupportRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("SupportRequestsList"); // Return to list
                return;
            }
        }
