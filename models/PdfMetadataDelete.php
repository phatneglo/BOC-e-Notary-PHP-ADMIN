 ...
 * Page class
 */
class PdfMetadataDelete extends PdfMetadata
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PdfMetadataDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PdfMetadataDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PdfMetadataList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PdfMetadataList"); // Return to list
                return;
            }
        }
