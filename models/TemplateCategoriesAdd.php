 ...
 * Page class
 */
class TemplateCategoriesAdd extends TemplateCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TemplateCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TemplateCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("TemplateCategoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "TemplateCategoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "TemplateCategoriesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TemplateCategoriesList") {
                            ...
                            $returnUrl = "TemplateCategoriesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TemplateCategoriesList"), "", $this->TableVar, true);
