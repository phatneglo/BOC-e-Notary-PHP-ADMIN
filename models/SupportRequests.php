...
/**
 * Table class for support_requests
 */
class SupportRequests extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "support_requests";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->request_type->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['request_type'] = &$this->request_type;

        // reference_number
        $this->reference_number = new DbField(
            $this, // Table
            'x_reference_number', // Variable name
            'reference_number', // Name
            '"reference_number"', // Expression
            '"reference_number"', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"reference_number"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->reference_number->InputTextType = "text";
        $this->reference_number->Nullable = false; // NOT NULL field
        $this->reference_number->Required = true; // Required field
        $this->reference_number->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['reference_number'] = &$this->reference_number;
        ...
        // resolved_at
        $this->resolved_at = new DbField(
            $this, // Table
            'x_resolved_at', // Variable name
            'resolved_at', // Name
            '"resolved_at"', // Expression
            CastDateFieldForLike("\"resolved_at\"", 0, "DB"), // Basic search expression
            135, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"resolved_at"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->resolved_at->InputTextType = "text";
        $this->resolved_at->Raw = true;
        $this->resolved_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->resolved_at->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['resolved_at'] = &$this->resolved_at;

        // response
        $this->_response = new DbField(
            $this, // Table
            'x__response', // Variable name
            'response', // Name
            '"response"', // Expression
            '"response"', // Basic search expression
            201, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"response"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->_response->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "support_requests";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->reference_number->DbValue = $row['reference_number'];
        $this->status->DbValue = $row['status'];
        $this->created_at->DbValue = $row['created_at'];
        $this->updated_at->DbValue = $row['updated_at'];
        $this->assigned_to->DbValue = $row['assigned_to'];
        $this->resolved_at->DbValue = $row['resolved_at'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SupportRequestsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "SupportRequestsView" => $Language->phrase("View"),
            "SupportRequestsEdit" => $Language->phrase("Edit"),
            "SupportRequestsAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SupportRequestsView",
            Config("API_ADD_ACTION") => "SupportRequestsAdd",
            Config("API_EDIT_ACTION") => "SupportRequestsEdit",
            Config("API_DELETE_ACTION") => "SupportRequestsDelete",
            Config("API_LIST_ACTION") => "SupportRequestsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SupportRequestsView", $parm);
        } else {
            $url = $this->keyUrl("SupportRequestsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "SupportRequestsAdd?" . $parm;
        } else {
            $url = "SupportRequestsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SupportRequestsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SupportRequestsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SupportRequestsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SupportRequestsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("SupportRequestsDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->reference_number->EditValue = $this->reference_number->CurrentValue;
        ...
        $this->resolved_at->EditValue = FormatDateTime($this->resolved_at->CurrentValue, $this->resolved_at->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->reference_number);
                    $doc->exportCaption($this->status);
                    $doc->exportCaption($this->created_at);
                    $doc->exportCaption($this->updated_at);
                    $doc->exportCaption($this->assigned_to);
                    $doc->exportCaption($this->resolved_at);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->reference_number);
                        $doc->exportField($this->status);
                        $doc->exportField($this->created_at);
                        $doc->exportField($this->updated_at);
                        $doc->exportField($this->assigned_to);
                        $doc->exportField($this->resolved_at);
