 ...
 * Page class
 */
class NotaryQrSettingsView extends NotaryQrSettings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotaryQrSettingsView";
    ...
    // CSS class/style
    public $CurrentPageName = "NotaryQrSettingsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("settings_id") ?? Route("settings_id")) !== null) {
            $this->RecKey["settings_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("settings_id") ?? Route("settings_id")) !== null) {
            ...
            $returnUrl = "NotaryQrSettingsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NotaryQrSettingsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
