 ...
 * Page class
 */
class FaqCategoriesView extends FaqCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaqCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "FaqCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("category_id") ?? Route("category_id")) !== null) {
            ...
            $returnUrl = "FaqCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FaqCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
