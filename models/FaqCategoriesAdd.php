 ...
 * Page class
 */
class FaqCategoriesAdd extends FaqCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaqCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "FaqCategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("FaqCategoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "FaqCategoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "FaqCategoriesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "FaqCategoriesList") {
                            ...
                            $returnUrl = "FaqCategoriesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FaqCategoriesList"), "", $this->TableVar, true);
