...
class PsgcView extends Psgc
{
    ...
    // CSS class/style
    public $CurrentPageName = "PsgcView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("code_10") ?? Route("code_10")) !== null) {
            ...
            $this->RecKey["code_10"] = $this->code_10->QueryStringValue;
        } elseif (Post("code_10") !== null) {
            $this->code_10->setFormValue(Post("code_10"));
            $this->RecKey["code_10"] = $this->code_10->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->code_10->setQueryStringValue($keyValue);
            $this->RecKey["code_10"] = $this->code_10->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PsgcList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PsgcList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
