 ...
 * Page class
 */
class PaymentTransactionsView extends PaymentTransactions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentTransactionsView";
    ...
    // CSS class/style
    public $CurrentPageName = "PaymentTransactionsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("transaction_id") ?? Route("transaction_id")) !== null) {
            ...
            $returnUrl = "PaymentTransactionsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PaymentTransactionsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
