 ...
 * Page class
 */
class DocumentVerificationView extends DocumentVerification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentVerificationView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentVerificationView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("verification_id") ?? Route("verification_id")) !== null) {
            $this->RecKey["verification_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("verification_id") ?? Route("verification_id")) !== null) {
            ...
            $this->RecKey["verification_id"] = $this->verification_id->QueryStringValue;
        } elseif (Post("verification_id") !== null) {
            $this->verification_id->setFormValue(Post("verification_id"));
            $this->RecKey["verification_id"] = $this->verification_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->verification_id->setQueryStringValue($keyValue);
            $this->RecKey["verification_id"] = $this->verification_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DocumentVerificationList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentVerificationList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
