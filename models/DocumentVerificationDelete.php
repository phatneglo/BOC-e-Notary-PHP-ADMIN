 ...
 * Page class
 */
class DocumentVerificationDelete extends DocumentVerification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentVerificationDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentVerificationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentVerificationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DocumentVerificationList"); // Return to list
                return;
            }
        }
