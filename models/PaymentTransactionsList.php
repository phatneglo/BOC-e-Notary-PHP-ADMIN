 ...
 * Page class
 */
class PaymentTransactionsList extends PaymentTransactions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentTransactionsList";
    ...
    public $FormName = "fpayment_transactionslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PaymentTransactionsList";
    ...
    public function setVisibility()
    {
        ...
        $this->gateway_response->Visible = false;
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "PaymentTransactionsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "PaymentTransactionsDelete";
        $this->MultiUpdateUrl = "PaymentTransactionsUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fpayment_transactionsgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fpayment_transactionssrch");
        }
        ...
        $filterList = Concat($filterList, $this->transaction_reference->AdvancedSearch->toJson(), ","); // Field transaction_reference
        ...
        $filterList = Concat($filterList, $this->gateway_reference->AdvancedSearch->toJson(), ","); // Field gateway_reference
        $filterList = Concat($filterList, $this->gateway_response->AdvancedSearch->toJson(), ","); // Field gateway_response
        ...
        $filterList = Concat($filterList, $this->payment_receipt_url->AdvancedSearch->toJson(), ","); // Field payment_receipt_url
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fpayment_transactionssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->transaction_reference->AdvancedSearch->SearchValue = @$filter["x_transaction_reference"];
        $this->transaction_reference->AdvancedSearch->SearchOperator = @$filter["z_transaction_reference"];
        $this->transaction_reference->AdvancedSearch->SearchCondition = @$filter["v_transaction_reference"];
        $this->transaction_reference->AdvancedSearch->SearchValue2 = @$filter["y_transaction_reference"];
        $this->transaction_reference->AdvancedSearch->SearchOperator2 = @$filter["w_transaction_reference"];
        $this->transaction_reference->AdvancedSearch->save();
        ...
        $this->gateway_reference->AdvancedSearch->SearchValue = @$filter["x_gateway_reference"];
        $this->gateway_reference->AdvancedSearch->SearchOperator = @$filter["z_gateway_reference"];
        $this->gateway_reference->AdvancedSearch->SearchCondition = @$filter["v_gateway_reference"];
        $this->gateway_reference->AdvancedSearch->SearchValue2 = @$filter["y_gateway_reference"];
        $this->gateway_reference->AdvancedSearch->SearchOperator2 = @$filter["w_gateway_reference"];
        $this->gateway_reference->AdvancedSearch->save();

        // Field gateway_response
        $this->gateway_response->AdvancedSearch->SearchValue = @$filter["x_gateway_response"];
        $this->gateway_response->AdvancedSearch->SearchOperator = @$filter["z_gateway_response"];
        $this->gateway_response->AdvancedSearch->SearchCondition = @$filter["v_gateway_response"];
        $this->gateway_response->AdvancedSearch->SearchValue2 = @$filter["y_gateway_response"];
        $this->gateway_response->AdvancedSearch->SearchOperator2 = @$filter["w_gateway_response"];
        $this->gateway_response->AdvancedSearch->save();
        ...
        // Field payment_receipt_url
        $this->payment_receipt_url->AdvancedSearch->SearchValue = @$filter["x_payment_receipt_url"];
        $this->payment_receipt_url->AdvancedSearch->SearchOperator = @$filter["z_payment_receipt_url"];
        $this->payment_receipt_url->AdvancedSearch->SearchCondition = @$filter["v_payment_receipt_url"];
        $this->payment_receipt_url->AdvancedSearch->SearchValue2 = @$filter["y_payment_receipt_url"];
        $this->payment_receipt_url->AdvancedSearch->SearchOperator2 = @$filter["w_payment_receipt_url"];
        $this->payment_receipt_url->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->transaction_reference;
        $searchFlds[] = &$this->currency;
        $searchFlds[] = &$this->status;
        $searchFlds[] = &$this->gateway_reference;
        $searchFlds[] = &$this->gateway_response;
        $searchFlds[] = &$this->payment_receipt_url;
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->transaction_reference->setSort("");
                $this->amount->setSort("");
                $this->currency->setSort("");
                $this->status->setSort("");
                $this->payment_date->setSort("");
                $this->gateway_reference->setSort("");
                $this->gateway_response->setSort("");
                $this->fee_amount->setSort("");
                $this->total_amount->setSort("");
                $this->payment_receipt_url->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"payment_transactions\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"payment_transactions\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"payment_transactions\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fpayment_transactionslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fpayment_transactionslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->transaction_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"payment_transactions\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "transaction_reference");
            ...
            $this->createColumnOption($option, "gateway_reference");
            $this->createColumnOption($option, "fee_amount");
            $this->createColumnOption($option, "total_amount");
            $this->createColumnOption($option, "payment_receipt_url");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpayment_transactionssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpayment_transactionssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpayment_transactionslist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_payment_transactions", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_payment_transactions",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpayment_transactionssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
