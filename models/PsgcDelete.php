...
class PsgcDelete extends Psgc
{
    ...
    // CSS class/style
    public $CurrentPageName = "PsgcDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PsgcList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PsgcList"); // Return to list
                return;
            }
        }
