 ...
 * Page class
 */
class NotarizationRequestsDelete extends NotarizationRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotarizationRequestsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NotarizationRequestsDelete";
    ...
    public function setVisibility()
    {
        ...
        $this->rejection_reason->Visible = false;
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NotarizationRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NotarizationRequestsList"); // Return to list
                return;
            }
        }
