 ...
 * Page class
 */
class SupportRequestsView extends SupportRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportRequestsView";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportRequestsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("request_id") ?? Route("request_id")) !== null) {
            ...
            $returnUrl = "SupportRequestsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SupportRequestsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
