 ...
 * Page class
 */
class DocumentAttachmentsDelete extends DocumentAttachments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentAttachmentsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentAttachmentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentAttachmentsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DocumentAttachmentsList"); // Return to list
                return;
            }
        }
