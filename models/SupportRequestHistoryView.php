 ...
 * Page class
 */
class SupportRequestHistoryView extends SupportRequestHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportRequestHistoryView";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportRequestHistoryView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("history_id") ?? Route("history_id")) !== null) {
            $this->RecKey["history_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("history_id") ?? Route("history_id")) !== null) {
            ...
            $this->RecKey["history_id"] = $this->history_id->QueryStringValue;
        } elseif (Post("history_id") !== null) {
            $this->history_id->setFormValue(Post("history_id"));
            $this->RecKey["history_id"] = $this->history_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->history_id->setQueryStringValue($keyValue);
            $this->RecKey["history_id"] = $this->history_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "SupportRequestHistoryList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SupportRequestHistoryList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
