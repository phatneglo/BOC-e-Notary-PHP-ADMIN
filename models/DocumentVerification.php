...
/**
 * Table class for document_verification
 */
class DocumentVerification extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_verification";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->verification_id->IsAutoIncrement = true; // Autoincrement field
        $this->verification_id->IsPrimaryKey = true; // Primary key field
        $this->verification_id->Nullable = false; // NOT NULL field
        $this->verification_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->verification_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->keycode->Nullable = false; // NOT NULL field
        $this->keycode->Required = true; // Required field
        $this->keycode->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['keycode'] = &$this->keycode;

        // verification_url
        $this->verification_url = new DbField(
            $this, // Table
            'x_verification_url', // Variable name
            'verification_url', // Name
            '"verification_url"', // Expression
            '"verification_url"', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"verification_url"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->verification_url->InputTextType = "text";
        $this->verification_url->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['verification_url'] = &$this->verification_url;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'document_verification', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // failed_attempts
        $this->failed_attempts = new DbField(
            $this, // Table
            'x_failed_attempts', // Variable name
            'failed_attempts', // Name
            '"failed_attempts"', // Expression
            'CAST("failed_attempts" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"failed_attempts"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->failed_attempts->addMethod("getDefault", fn() => 0);
        $this->failed_attempts->InputTextType = "text";
        $this->failed_attempts->Raw = true;
        $this->failed_attempts->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->failed_attempts->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['failed_attempts'] = &$this->failed_attempts;

        // blocked_until
        $this->blocked_until = new DbField(
            $this, // Table
            'x_blocked_until', // Variable name
            'blocked_until', // Name
            '"blocked_until"', // Expression
            CastDateFieldForLike("\"blocked_until\"", 0, "DB"), // Basic search expression
            135, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"blocked_until"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->blocked_until->InputTextType = "text";
        $this->blocked_until->Raw = true;
        $this->blocked_until->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->blocked_until->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['blocked_until'] = &$this->blocked_until;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_verification";
    }
    ...
    public function insert(&$rs)
    {
        ...
        try {
            ...
            $result = $conn->executeQuery(
                $queryBuilder->getSQL() . " RETURNING verification_id",
        ...
        if ($result) {
            $this->verification_id->setDbValue($result);
            $rs['verification_id'] = $this->verification_id->DbValue;
        }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['verification_id']) && !EmptyValue($this->verification_id->CurrentValue)) {
                $rs['verification_id'] = $this->verification_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('verification_id', $rs)) {
                AddFilter($where, QuotedName('verification_id', $this->Dbid) . '=' . QuotedValue($rs['verification_id'], $this->verification_id->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->verification_url->DbValue = $row['verification_url'];
        ...
        $this->failed_attempts->DbValue = $row['failed_attempts'];
        $this->blocked_until->DbValue = $row['blocked_until'];
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->verification_id->CurrentValue : $this->verification_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->verification_id->CurrentValue = $keys[0];
            } else {
                $this->verification_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('verification_id', $row) ? $row['verification_id'] : null;
        } else {
            $val = !EmptyValue($this->verification_id->OldValue) && !$current ? $this->verification_id->OldValue : $this->verification_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@verification_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentVerificationList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DocumentVerificationView" => $Language->phrase("View"),
            "DocumentVerificationEdit" => $Language->phrase("Edit"),
            "DocumentVerificationAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DocumentVerificationView",
            Config("API_ADD_ACTION") => "DocumentVerificationAdd",
            Config("API_EDIT_ACTION") => "DocumentVerificationEdit",
            Config("API_DELETE_ACTION") => "DocumentVerificationDelete",
            Config("API_LIST_ACTION") => "DocumentVerificationList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentVerificationView", $parm);
        } else {
            $url = $this->keyUrl("DocumentVerificationView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentVerificationAdd?" . $parm;
        } else {
            $url = "DocumentVerificationAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentVerificationEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentVerificationList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentVerificationAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentVerificationList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentVerificationDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"verification_id\":" . VarToJson($this->verification_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->verification_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->verification_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("verification_id") ?? Route("verification_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->verification_id->CurrentValue = $key;
            } else {
                $this->verification_id->OldValue = $key;
            }
    ...
    {
        global $Response;
        $listPage = "DocumentVerificationList";
    ...
    public function renderEditRow()
    {
        ...
        $this->verification_url->EditValue = $this->verification_url->CurrentValue;
        ...
        $this->blocked_until->EditValue = FormatDateTime($this->blocked_until->CurrentValue, $this->blocked_until->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->verification_url);
                    $doc->exportCaption($this->qr_code_path);
                    $doc->exportCaption($this->is_active);
                    $doc->exportCaption($this->expiry_date);
                    $doc->exportCaption($this->created_at);
                    $doc->exportCaption($this->failed_attempts);
                    $doc->exportCaption($this->blocked_until);
                } else {
                    $doc->exportCaption($this->verification_id);
                    $doc->exportCaption($this->notarized_id);
                    $doc->exportCaption($this->document_number);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->verification_url);
                        $doc->exportField($this->qr_code_path);
                        $doc->exportField($this->is_active);
                        $doc->exportField($this->expiry_date);
                        $doc->exportField($this->created_at);
                        $doc->exportField($this->failed_attempts);
                        $doc->exportField($this->blocked_until);
                    } else {
                        $doc->exportField($this->verification_id);
                        $doc->exportField($this->notarized_id);
                        $doc->exportField($this->document_number);
