 ...
 * Page class
 */
class FaqCategoriesDelete extends FaqCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FaqCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "FaqCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FaqCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("FaqCategoriesList"); // Return to list
                return;
            }
        }
