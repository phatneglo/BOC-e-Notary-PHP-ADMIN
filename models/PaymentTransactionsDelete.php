 ...
 * Page class
 */
class PaymentTransactionsDelete extends PaymentTransactions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentTransactionsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PaymentTransactionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PaymentTransactionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PaymentTransactionsList"); // Return to list
                return;
            }
        }
