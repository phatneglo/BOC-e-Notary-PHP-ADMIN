 ...
 * Page class
 */
class DocumentFieldsView extends DocumentFields
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentFieldsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentFieldsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("document_field_id") ?? Route("document_field_id")) !== null) {
            $this->RecKey["document_field_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("document_field_id") ?? Route("document_field_id")) !== null) {
            ...
            $this->RecKey["document_field_id"] = $this->document_field_id->QueryStringValue;
        } elseif (Post("document_field_id") !== null) {
            $this->document_field_id->setFormValue(Post("document_field_id"));
            $this->RecKey["document_field_id"] = $this->document_field_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->document_field_id->setQueryStringValue($keyValue);
            $this->RecKey["document_field_id"] = $this->document_field_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DocumentFieldsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentFieldsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
