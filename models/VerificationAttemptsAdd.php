 ...
 * Page class
 */
class VerificationAttemptsAdd extends VerificationAttempts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VerificationAttemptsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "VerificationAttemptsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "VerificationAttemptsView") {
    ...
    protected function getAddRow()
    {
        ...
        // verification_id
        $this->verification_id->setDbValueDef($rsnew, $this->verification_id->CurrentValue, false);
        ...
        $this->is_successful->setDbValueDef($rsnew, $tmpBool, false);

        // failure_reason
        $this->failure_reason->setDbValueDef($rsnew, $this->failure_reason->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['verification_id'])) { // verification_id
            $this->verification_id->setFormValue($row['verification_id']);
        }
        ...
        if (isset($row['is_successful'])) { // is_successful
            $this->is_successful->setFormValue($row['is_successful']);
        }
        if (isset($row['failure_reason'])) { // failure_reason
            $this->failure_reason->setFormValue($row['failure_reason']);
        }
