 ...
 * Page class
 */
class DocumentActivityLogsDelete extends DocumentActivityLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentActivityLogsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentActivityLogsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentActivityLogsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DocumentActivityLogsList"); // Return to list
                return;
            }
        }
