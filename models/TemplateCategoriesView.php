 ...
 * Page class
 */
class TemplateCategoriesView extends TemplateCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TemplateCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TemplateCategoriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("category_id") ?? Route("category_id")) !== null) {
            ...
            $returnUrl = "TemplateCategoriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TemplateCategoriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
