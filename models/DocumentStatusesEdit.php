 ...
 * Page class
 */
class DocumentStatusesEdit extends DocumentStatuses
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentStatusesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentStatusesEdit";
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (status_code)
        if ($this->status_code->CurrentValue != "") {
            $filterChk = "(\"status_code\" = '" . AdjustSql($this->status_code->CurrentValue, $this->Dbid) . "')";
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['status_name'])) { // status_name
            $this->status_name->CurrentValue = $row['status_name'];
        }
