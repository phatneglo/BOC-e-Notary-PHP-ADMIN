 ...
 * Page class
 */
class PdfMetadataView extends PdfMetadata
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PdfMetadataView";
    ...
    // CSS class/style
    public $CurrentPageName = "PdfMetadataView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("metadata_id") ?? Route("metadata_id")) !== null) {
            $this->RecKey["metadata_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("metadata_id") ?? Route("metadata_id")) !== null) {
            ...
            $this->RecKey["metadata_id"] = $this->metadata_id->QueryStringValue;
        } elseif (Post("metadata_id") !== null) {
            $this->metadata_id->setFormValue(Post("metadata_id"));
            $this->RecKey["metadata_id"] = $this->metadata_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->metadata_id->setQueryStringValue($keyValue);
            $this->RecKey["metadata_id"] = $this->metadata_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PdfMetadataList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PdfMetadataList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
