 ...
 * Page class
 */
class DocumentTemplatesView extends DocumentTemplates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentTemplatesView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentTemplatesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("template_id") ?? Route("template_id")) !== null) {
            $this->RecKey["template_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("template_id") ?? Route("template_id")) !== null) {
            ...
            $this->RecKey["template_id"] = $this->template_id->QueryStringValue;
        } elseif (Post("template_id") !== null) {
            $this->template_id->setFormValue(Post("template_id"));
            $this->RecKey["template_id"] = $this->template_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->template_id->setQueryStringValue($keyValue);
            $this->RecKey["template_id"] = $this->template_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DocumentTemplatesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentTemplatesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
