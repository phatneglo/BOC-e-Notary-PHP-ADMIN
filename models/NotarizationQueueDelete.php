 ...
 * Page class
 */
class NotarizationQueueDelete extends NotarizationQueue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotarizationQueueDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NotarizationQueueDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NotarizationQueueList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NotarizationQueueList"); // Return to list
                return;
            }
        }
