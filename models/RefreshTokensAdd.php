 ...
 * Page class
 */
class RefreshTokensAdd extends RefreshTokens
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RefreshTokensAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "RefreshTokensAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RefreshTokensView") {
