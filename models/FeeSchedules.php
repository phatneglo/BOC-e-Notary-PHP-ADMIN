...
/**
 * Table class for fee_schedules
 */
class FeeSchedules extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "fee_schedules";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // fee_id
        $this->fee_id = new DbField(
            $this, // Table
            'x_fee_id', // Variable name
            'fee_id', // Name
            '"fee_id"', // Expression
            'CAST("fee_id" AS varchar(255))', // Basic search expression
            3, // Type
            0, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"fee_id"', // Virtual expression
            false, // Is virtual
        ...
        $this->fee_id->InputTextType = "text";
        $this->fee_id->Raw = true;
        $this->fee_id->IsAutoIncrement = true; // Autoincrement field
        $this->fee_id->IsPrimaryKey = true; // Primary key field
        $this->fee_id->Nullable = false; // NOT NULL field
        $this->fee_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->fee_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        // fee_name
        $this->fee_name = new DbField(
            $this, // Table
            'x_fee_name', // Variable name
            'fee_name', // Name
            '"fee_name"', // Expression
            '"fee_name"', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"fee_name"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->fee_name->InputTextType = "text";
        $this->fee_name->Nullable = false; // NOT NULL field
        $this->fee_name->Required = true; // Required field
        $this->fee_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['fee_name'] = &$this->fee_name;
        ...
        $this->fee_amount->Nullable = false; // NOT NULL field
        $this->fee_amount->Required = true; // Required field
        $this->fee_amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->fee_amount->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['fee_amount'] = &$this->fee_amount;

        // fee_type
        $this->fee_type = new DbField(
            $this, // Table
            'x_fee_type', // Variable name
            'fee_type', // Name
            '"fee_type"', // Expression
            '"fee_type"', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '"fee_type"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->fee_type->addMethod("getDefault", fn() => "fixed");
        $this->fee_type->InputTextType = "text";
        $this->fee_type->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['fee_type'] = &$this->fee_type;
        ...
        // effective_from
        $this->effective_from = new DbField(
            $this, // Table
            'x_effective_from', // Variable name
            'effective_from', // Name
            '"effective_from"', // Expression
            CastDateFieldForLike("\"effective_from\"", 0, "DB"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"effective_from"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->effective_from->InputTextType = "text";
        $this->effective_from->Raw = true;
        $this->effective_from->Nullable = false; // NOT NULL field
        $this->effective_from->Required = true; // Required field
        $this->effective_from->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->effective_from->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['effective_from'] = &$this->effective_from;

        // effective_to
        $this->effective_to = new DbField(
            $this, // Table
            'x_effective_to', // Variable name
            'effective_to', // Name
            '"effective_to"', // Expression
            CastDateFieldForLike("\"effective_to\"", 0, "DB"), // Basic search expression
            133, // Type
            0, // Size
            0, // Date/Time format
            false, // Is upload field
            '"effective_to"', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->effective_to->InputTextType = "text";
        $this->effective_to->Raw = true;
        $this->effective_to->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->effective_to->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['effective_to'] = &$this->effective_to;
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'fee_schedules', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "fee_schedules";
    }
    ...
    public function insert(&$rs)
    {
        ...
        try {
            ...
            $result = $conn->executeQuery(
                $queryBuilder->getSQL() . " RETURNING fee_id",
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['fee_id']) && !EmptyValue($this->fee_id->CurrentValue)) {
                $rs['fee_id'] = $this->fee_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('fee_id', $rs)) {
                AddFilter($where, QuotedName('fee_id', $this->Dbid) . '=' . QuotedValue($rs['fee_id'], $this->fee_id->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->fee_name->DbValue = $row['fee_name'];
        $this->fee_amount->DbValue = $row['fee_amount'];
        $this->fee_type->DbValue = $row['fee_type'];
        $this->currency->DbValue = $row['currency'];
        $this->effective_from->DbValue = $row['effective_from'];
        $this->effective_to->DbValue = $row['effective_to'];
    ...
    {
        $keys = [];
        $val = $current ? $this->fee_id->CurrentValue : $this->fee_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->fee_id->CurrentValue = $keys[0];
            } else {
                $this->fee_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('fee_id', $row) ? $row['fee_id'] : null;
        } else {
            $val = !EmptyValue($this->fee_id->OldValue) && !$current ? $this->fee_id->OldValue : $this->fee_id->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@fee_id@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FeeSchedulesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "FeeSchedulesView" => $Language->phrase("View"),
            "FeeSchedulesEdit" => $Language->phrase("Edit"),
            "FeeSchedulesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FeeSchedulesView",
            Config("API_ADD_ACTION") => "FeeSchedulesAdd",
            Config("API_EDIT_ACTION") => "FeeSchedulesEdit",
            Config("API_DELETE_ACTION") => "FeeSchedulesDelete",
            Config("API_LIST_ACTION") => "FeeSchedulesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FeeSchedulesView", $parm);
        } else {
            $url = $this->keyUrl("FeeSchedulesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FeeSchedulesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FeeSchedulesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FeeSchedulesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FeeSchedulesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FeeSchedulesDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"fee_id\":" . VarToJson($this->fee_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->fee_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->fee_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("fee_id") ?? Route("fee_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function renderEditRow()
    {
        ...
        // fee_id
        $this->fee_id->setupEditAttributes();
        ...
        $this->fee_name->EditValue = $this->fee_name->CurrentValue;
        ...
        $this->fee_type->EditValue = $this->fee_type->CurrentValue;
        ...
        $this->effective_from->EditValue = FormatDateTime($this->effective_from->CurrentValue, $this->effective_from->formatPattern());
        $this->effective_from->PlaceHolder = RemoveHtml($this->effective_from->caption());

        // effective_to
        $this->effective_to->setupEditAttributes();
        $this->effective_to->EditValue = FormatDateTime($this->effective_to->CurrentValue, $this->effective_to->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->fee_id);
                    $doc->exportCaption($this->template_id);
                    $doc->exportCaption($this->fee_name);
                    $doc->exportCaption($this->fee_amount);
                    $doc->exportCaption($this->fee_type);
                    $doc->exportCaption($this->currency);
                    $doc->exportCaption($this->effective_from);
                    $doc->exportCaption($this->effective_to);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->fee_id);
                        $doc->exportField($this->template_id);
                        $doc->exportField($this->fee_name);
                        $doc->exportField($this->fee_amount);
                        $doc->exportField($this->fee_type);
                        $doc->exportField($this->currency);
                        $doc->exportField($this->effective_from);
                        $doc->exportField($this->effective_to);
