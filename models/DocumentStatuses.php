...
/**
 * Table class for document_statuses
 */
class DocumentStatuses extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "document_statuses";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->status_name->Nullable = false; // NOT NULL field
        $this->status_name->Required = true; // Required field
        $this->status_name->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->is_active->Lookup = new Lookup($this->is_active, 'document_statuses', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "document_statuses";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DocumentStatusesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DocumentStatusesView" => $Language->phrase("View"),
            "DocumentStatusesEdit" => $Language->phrase("Edit"),
            "DocumentStatusesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DocumentStatusesView",
            Config("API_ADD_ACTION") => "DocumentStatusesAdd",
            Config("API_EDIT_ACTION") => "DocumentStatusesEdit",
            Config("API_DELETE_ACTION") => "DocumentStatusesDelete",
            Config("API_LIST_ACTION") => "DocumentStatusesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DocumentStatusesView", $parm);
        } else {
            $url = $this->keyUrl("DocumentStatusesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DocumentStatusesAdd?" . $parm;
        } else {
            $url = "DocumentStatusesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentStatusesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentStatusesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentStatusesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DocumentStatusesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DocumentStatusesDelete", $parm);
        }
    }
