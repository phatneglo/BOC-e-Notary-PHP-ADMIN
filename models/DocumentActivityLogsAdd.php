 ...
 * Page class
 */
class DocumentActivityLogsAdd extends DocumentActivityLogs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentActivityLogsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentActivityLogsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("DocumentActivityLogsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "DocumentActivityLogsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "DocumentActivityLogsView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "DocumentActivityLogsList") {
                            ...
                            $returnUrl = "DocumentActivityLogsList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DocumentActivityLogsList"), "", $this->TableVar, true);
