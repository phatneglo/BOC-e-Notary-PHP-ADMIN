 ...
 * Page class
 */
class SupportRequestHistoryAdd extends SupportRequestHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SupportRequestHistoryAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "SupportRequestHistoryAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SupportRequestHistoryView") {
