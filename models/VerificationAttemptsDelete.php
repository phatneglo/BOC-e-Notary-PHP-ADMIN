 ...
 * Page class
 */
class VerificationAttemptsDelete extends VerificationAttempts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VerificationAttemptsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VerificationAttemptsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("VerificationAttemptsList"); // Return to list
                return;
            }
        }
