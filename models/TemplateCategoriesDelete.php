 ...
 * Page class
 */
class TemplateCategoriesDelete extends TemplateCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TemplateCategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TemplateCategoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TemplateCategoriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TemplateCategoriesList"); // Return to list
                return;
            }
        }
