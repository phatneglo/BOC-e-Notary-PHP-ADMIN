...
/**
 * PaymentDashboard controller
 */
class PaymentDashboardController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/PaymentDashboard[/{params:.*}]", [PermissionMiddleware::class], "custom.PaymentDashboard")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "PaymentDashboard");
    }
}
